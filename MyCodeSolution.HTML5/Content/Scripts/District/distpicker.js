...
(function (factory) {
    ...
    (function ($, ChineseDistricts) {
        ...
        Distpicker.prototype = {
            constructor: Distpicker, init: function () {
            ...
            output: function (type) {
                ...
                if ($.isPlainObject(districts)) {
                    $.each(districts, function (code, address) {
                        ...
                        if (type === PROVINCE) {
                            if (options.provinceSingle) {
                                if (address === options.province)
                            ...
                            if (options.citySingle) {
                                if (address === options.city)
                                    data.push({ code: code, address: address, selected: selected });
                            }
                            else
                                data.push({ code: code, address: address, selected: selected });
                            ...
                            if (options.districtSingle) {
                                if (address === options.district)
                                    data.push({ code: code, address: address, selected: selected });
                            }
                            else
                                data.push({ code: code, address: address, selected: selected });
                ...
                if (options.placeholder) {
                    data.unshift({ code: '', address: options[type + 'Top'], selected: false });
                }
